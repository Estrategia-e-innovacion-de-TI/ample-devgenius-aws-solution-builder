"""
Herramienta: Generar documentación técnica.
"""
import os
import json
import datetime
...
@tool
def generate_doc(conversation_context: str) -> str:
    """
    Genera documentación técnica completa y profesional para la solución
    ...
    Returns:
        La documentación generada y la ruta del archivo exportado.
    """
