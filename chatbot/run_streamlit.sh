...
export BEDROCK_AGENT_ID="LRHHMHTUNJ"
export BEDROCK_AGENT_ALIAS_ID="RNWSCUQZCJ"
export S3_BUCKET_NAME="devgenius-data-source-538430999815-us-east-1"
export CONVERSATION_TABLE_NAME="devgenius-conversation-table"
export FEEDBACK_TABLE_NAME="devgenius-feedback-table"
export SESSION_TABLE_NAME="devgenius-session-table"
