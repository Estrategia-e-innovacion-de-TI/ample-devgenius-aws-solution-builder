        ...
        const viewerRequestLambda = new cloudfront.experimental.EdgeFunction(this, "function", {
            ...
            initialPolicy: [
                new iam.PolicyStatement({
                    ...
                    resources: [`arn:aws:secretsmanager:us-east-1:*:secret:cognitoClientSecrets*`]
                })
            ]
        })
        
        // Suppress CDK-Nag for Lambda@Edge
        cdk_nag.NagSuppressions.addResourceSuppressions(viewerRequestLambda, [
            { 
                id: "AwsSolutions-IAM4", 
                reason: "Lambda Edge function requires basic execution role", 
                appliesTo: ['Policy::arn:<AWS::Partition>:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole']
            },
            {
                id: "AwsSolutions-IAM5",
                reason: "Lambda Edge function requires access to Secrets Manager with a pattern",
                appliesTo: ['Resource::arn:aws:secretsmanager:us-east-1:*:secret:cognitoClientSecrets*']
            }
        ], true)
...
new DevGeniusStack(app, "dev-genius-stack", { stackName: stackName, env: { region: "us-east-1" } })
...
try {
  ...
  console.log('Edge lambda stack not found. This is expected during the first synthesis.');
}
